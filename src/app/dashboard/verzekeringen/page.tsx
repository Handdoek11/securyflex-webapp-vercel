...
import { Shield, ChevronRight, Search, Filter, Percent, Star, Info, Lock, Check, Loader2, AlertCircle, Gift, Building2, User, Heart } from "lucide-react";
  ...
  "1": [ // Zakelijke verzekeringen
    {
      ...
      beschrijving: "Dekt schade die je veroorzaakt tijdens je werk als beveiliger",
...
export default function VerzekeringenPage() {
  ...
  const [showKortingBanner, setShowKortingBanner] = useState(true);
  ...
  const loadProducts = async (categoryId: string) => {
    try {
      const res = await fetch(`/api/verzekeringen/producten?categorieId=${categoryId}`);
  ...
  const handleApplyDiscount = () => {
    ...
    toast.success(`Kortingscode ${kortingCode} wordt toegepast bij je aanvraag`);
  };
      ...
      >
        <div className="p-4">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              De verzekeringen module is exclusief beschikbaar voor SecuryFlex leden met een actief abonnement.
              Upgrade vandaag nog en krijg toegang tot exclusieve kortingen!
            </AlertDescription>
          </Alert>
          ...
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Krijg toegang tot exclusieve verzekeringskortingen en meer voordelen
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Op verzekeringen</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-500 mt-0.5" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Exclusieve kortingscodes</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-500 mt-0.5" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Met belastingvoordeel</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-green-500 mt-0.5" />
        ...
        {showKortingBanner && (
          <Alert className="border-green-200 bg-green-50 dark:bg-green-950/20">
            ...
            <AlertDescription className="text-green-700 dark:text-green-300">
              Gebruik code <span className="font-mono font-bold">SECURYFLEX25</span> voor 25% extra korting op je eerste verzekering.
              Deze code is geldig tot 31 december 2025.
            </AlertDescription>
          </Alert>
        )}
            ...
            <TabsContent key={category.id} value={category.id} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-muted-foreground">{category.beschrijving}</p>
                </div>
                  ...
                  .map((product) => (
                    <Card
                      ...
                      className={`cursor-pointer transition-all hover:shadow-lg ${
                        product.isFeatured ? 'border-primary ring-2 ring-primary/20' : ''
                      }`}
                      ...
                      <CardHeader>
                        <div className="flex justify-between items-start mb-2">
                          <div className="flex-1">
                            <CardTitle className="text-lg">{product.naam}</CardTitle>
                            {product.isFeatured && (
                        ...
                        <CardDescription>{product.korteBeschrijving}</CardDescription>
                      </CardHeader>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-bold">
                            €{(product.basispremie * (1 - product.platformKorting/100)).toFixed(2)}
                          </span>
                          {product.platformKorting > 0 && (
              ...
              {products.length === 0 && (
                <Card className="p-8">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-semibold mb-2">Geen verzekeringen gevonden</p>
