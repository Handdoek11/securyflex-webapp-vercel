...
const EarningsCalculator = dynamic(
  () =>
    import("@/components/landing/EarningsCalculator").then((mod) => ({
      default: mod.EarningsCalculator,
    })),
  {
    loading: () => (
      <div className="h-96 bg-gray-100 animate-pulse rounded-lg mx-auto max-w-4xl" />
    ),
    ssr: false, // Client-side only for interactive calculator
  },
);

const LiveShiftTicker = dynamic(
  () =>
    import("@/components/landing/LiveShiftTicker").then((mod) => ({
      default: mod.LiveShiftTicker,
    })),
  {
    loading: () => (
      <div className="h-16 bg-gray-100 animate-pulse rounded mx-4" />
    ),
    ssr: false, // Real-time data, client-side only
  },
);

const DynamicAppDownloadSection = dynamic(
  () =>
    import("@/components/landing/AppDownloadSection").then((mod) => ({
...
const DynamicFAQSection = dynamic(
  () =>
    import("@/components/landing/FAQSection").then((mod) => ({
...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageErrorBoundary>
        <PageTransition transitionKey={activeRole || "home"}>
          <SectionTransition>
            <HeroSection />
          </SectionTransition>
        </PageTransition>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              {(activeRole === "ZZP_BEVEILIGER" || !activeRole) && (
                <div className="bg-white rounded-xl p-6 shadow-sm border text-center md:text-left">
                  ...
                  <p className="text-sm mb-4">
                    "Van €1.800 naar €3.200 per maand. GPS check-in werkt
                    perfect, betaling altijd op tijd."
                  </p>
                  <div>
              ...
              {(activeRole === "BEDRIJF" || !activeRole) && (
                <div className="bg-white rounded-xl p-6 shadow-sm border text-center md:text-left">
                  ...
                  <p className="text-sm mb-4">
                    "Platform geeft toegang tot gekwalificeerde ZZP'ers. We
                    winnen nu 3x meer opdrachten."
                  </p>
                  <div>
              ...
              {activeRole === "OPDRACHTGEVER" && (
                <>
                  <div className="bg-white rounded-xl p-6 shadow-sm border text-center md:text-left">
                    ...
                    <p className="text-sm mb-4">
                      "Voor ons bouwproject hadden we direct 5 beveiligers
                      nodig. Binnen een uur geregeld!"
                    </p>
                    <div>
      ...
      {/* Earnings Calculator - Only for Beveiligers - After testimonials */}
      {activeRole === "ZZP_BEVEILIGER" && (
        <ComponentErrorBoundary>
          <SectionTransition delay={0.65}>
            <section className="py-16 lg:py-24 bg-gray-50">
              <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                  <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                    BEREKEN JE POTENTIËLE INKOMEN
                  </h2>
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Ontdek hoeveel je kunt verdienen als ZZP beveiliger op ons
                    platform. Beveiligers verdienen gemiddeld €3.200 extra per
                    maand.
                  </p>
                </div>
                <EarningsCalculator />
