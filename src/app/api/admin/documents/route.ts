    ...
    return NextResponse.json({
      ...
      data: {
        ...
        stats: {
          ...
          expiringCount,
          byDocumentType: documentTypeStats.reduce((acc, item) => {
        ...
        for (const documentId of documentIds) {
          ...
          if (currentDoc && currentDoc.status !== "APPROVED") {
            ...
            try {
              ...
              console.error(`Failed to send approval notification for document ${documentId}:`, notificationError);
        ...
        for (const documentId of documentIds) {
          ...
          if (currentDoc && currentDoc.status !== "REJECTED") {
            ...
            try {
              ...
              console.error(`Failed to send rejection notification for document ${documentId}:`, notificationError);
              // Don't fail the bulk operation if notification fails
            }
