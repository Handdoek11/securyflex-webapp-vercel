  ...
  try {
    ...
    try {
      ...
      if (action === "add") {
        ...
        console.log(`Beveiliger ${beveiligerId} added to favorites by opdrachtgever ${opdrachtgeverProfile.id}`);
        ...
        console.log(`Beveiliger ${beveiligerId} removed from favorites by opdrachtgever ${opdrachtgeverProfile.id}`);
