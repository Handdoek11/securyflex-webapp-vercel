...
import { Eye, EyeOff, Loader2, AlertCircle, ArrowLeft, Shield, CheckCircle } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Card } from "@/components/ui/card";
import { Checkbox } from "@/components/ui/checkbox";
import { zzpRegistrationSchema, type ZZPRegistrationFormData } from "@/lib/validations/auth";
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div className="text-left">
              <h1 className="text-2xl font-bold text-foreground">ZZP Beveiliger</h1>
