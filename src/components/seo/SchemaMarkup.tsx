    ...
    switch (type) {
      case 'organization':
        return {
          ...
          "description": "WPBR geverifieerd platform voor beveiligers. GPS check-in, 24u betaling gegarandeerd. Verdien gemiddeld €2.400 extra per maand.",
          "foundingDate": "2024",
          ...
          "keywords": ["beveiliging", "beveiliger", "zzp", "wpbr", "security", "beveiligingsbedrijf"]
        };
      ...
      case 'service':
        return {
          ...
          "description": "Platform dat beveiligers, beveiligingsbedrijven en opdrachtgevers verbindt voor flexibele beveiligingsopdrachten",
          "provider": {
            "@type": "Organization",
            "name": "SecuryFlex"
          },
          ...
          "offers": [
            {
              ...
              "description": "Vind flexibele beveiligingsopdrachten, verdien €28+ per uur, betaling binnen 24 uur",
              "category": "ZZP Beveiliging"
            },
            {
              "@type": "Offer",
              "name": "Voor Beveiligingsbedrijven",
              "description": "Toegang tot 2847+ beveiligers, automatische planning, real-time monitoring",
              "category": "B2B Platform"
            },
            {
              "@type": "Offer",
              "name": "Voor Opdrachtgevers",
              "description": "Beveiliging binnen 5 minuten, transparante prijzen, live GPS tracking",
          ...
          "review": [
            {
              ...
              "reviewBody": "Van €1.800 naar €3.200 per maand. GPS check-in werkt perfect, betaling altijd op tijd."
            }
          ]
        };
...
export function RoleSpecificSchema({ role }: { role: string | null }) {
  if (role === 'beveiligers') {
    return (
      <>
        <SchemaMarkup type="organization" />
        <SchemaMarkup type="jobPosting" data={{
          title: "ZZP Beveiliger Vacatures",
          description: "Flexibele beveiligingsopdrachten voor ZZP beveiligers. WPBR vereist, €28+ per uur, betaling binnen 24 uur.",
          location: "Nederland",
          hourlyRate: 28,
