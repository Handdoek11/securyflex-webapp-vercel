...
test.describe("ND-nummer Complete Workflow", () => {
            ...
            await route.fulfill({
              ...
              body: JSON.stringify({
                ...
                nextActions: {
                  ...
                  statusUrl:
                    "/api/compliance/nd-nummer/validate?profileType=ZZP",
                },
              }),
            });
          } else {
  ...
  test("Complete ZZP ND-nummer registration and verification flow", async ({
    page,
  }) => {
  ...
  test("Bedrijf ND-nummer registration with company details", async ({
    page,
  }) => {
  ...
  test("ND-nummer expiry warnings and renewal flow", async ({ page }) => {
    ...
    await page.route(
      "**/api/compliance/nd-nummer/validate",
      async (route, request) => {
    ...
    await expect(
      page.locator('button:has-text("Plan Vernieuwing")'),
    ).toBeVisible();
    ...
    await expect(
      page.locator("text=Plan vernieuwing binnen 30 dagen"),
    ).toBeVisible();
  });
  ...
  test("Mobile responsive compliance dashboard", async ({ page }) => {
    ...
    if (firstCardBox && lastCardBox) {
      ...
      expect(lastCardBox.y).toBeGreaterThan(
  ...
  test("Accessibility compliance for ND-nummer forms", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Voer uw Nederlandse Dienstnummer in"),
    ).toBeVisible();
            ...
            body: JSON.stringify({
              ...
              auditHistory: [
                ...
                },
                {
                  ...
                  complianceNotes:
                    "Notificatie verstuurd: EXPIRY_WARNING_90_DAYS",
                },
              ],
            }),
          });
