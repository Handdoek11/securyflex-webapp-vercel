...
import {
  GET as monitorGet,
  POST as monitorPost,
} from "@/app/api/compliance/nd-nummer/monitor/route";
import {
  GET as notificationGet,
  POST as notificationPost,
} from "@/app/api/compliance/nd-nummer/notifications/route";
import { POST as registerPost } from "@/app/api/compliance/nd-nummer/register/route";
import {
  GET as validateGet,
  POST as validatePost,
} from "@/app/api/compliance/nd-nummer/validate/route";
...
describe("ND-nummer API Integration Tests", () => {
  ...
  describe("ND-nummer Registration API", () => {
    it("should register ND-nummer for ZZP profile successfully", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/compliance/nd-nummer/register",
        {
          method: "POST",
  ...
  describe("ND-nummer Validation API", () => {
    it("should validate ND-nummer via mock Justis API", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/compliance/nd-nummer/validate",
        {
          method: "POST",
          body: JSON.stringify(requestData),
        },
    ...
    it("should get ND-nummer status for user", async () => {
      ...
      const url = new URL(
        "http://localhost/api/compliance/nd-nummer/validate?profileType=ZZP",
      );
  ...
  describe("ND-nummer Monitoring API", () => {
    ...
    it("should get platform-wide compliance monitoring for admin", async () => {
      ...
      vi.mocked(prisma.zZPProfile.findMany).mockResolvedValue(
        mockProfiles as any,
      );
      ...
      const url = new URL(
        "http://localhost/api/compliance/nd-nummer/monitor?scope=platform",
      );
      const request = new NextRequest(url);
    ...
    it("should run compliance check on specific profiles", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/compliance/nd-nummer/monitor",
        {
          method: "POST",
          body: JSON.stringify(requestData),
        },
  ...
  describe("ND-nummer Notifications API", () => {
    ...
    it("should send manual ND-nummer notification", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/compliance/nd-nummer/notifications",
        {
          method: "POST",
          body: JSON.stringify(requestData),
        },
    ...
    it("should get notification history for profile", async () => {
      ...
      const url = new URL(
        "http://localhost/api/compliance/nd-nummer/notifications?profileId=zzp123&profileType=ZZP",
      );
      const request = new NextRequest(url);
