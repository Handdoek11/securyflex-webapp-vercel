...
describe("API Schema Validation Tests", () => {
  ...
  describe("BedrijfProfile Endpoints", () => {
    it("should handle new BedrijfProfile fields correctly", async () => {
      ...
      prismaMock.bedrijfProfile.findUnique.mockResolvedValue(
        mockBedrijfProfile,
      );
  ...
  describe("Opdracht Endpoints", () => {
    it("should handle OpdrachtLocatie relation correctly", async () => {
      const mockOpdracht = {
        ...
        uurtarief: 27.5, // Changed from uurloon
        vereisten: ["BOA", "BHV"],
        status: "OPEN",
      ...
      const apiResponse = {
        ...
        data: {
          opdracht: {
            id: "opdracht-1",
            titel: "Test Opdracht",
            uurtarief: 25.5, // Correct field name
