...
const baseRegistrationFields = {
  ...
  phone: z
    ...
    .regex(/^(\+31|0)[0-9]{9}$/, "Voer een geldig Nederlands telefoonnummer in"),
  agreeToTerms: z
    .boolean()
...
export const zzpRegistrationSchema = z.object({
  ...baseRegistrationFields,
...
export const bedrijfRegistrationSchema = z.object({
  ...baseRegistrationFields,
...
export const opdrachtgeverRegistrationSchema = z.object({
  ...baseRegistrationFields,
...
export const bedrijfBusinessInfoSchema = kvkValidationSchema.extend({
  ...
  wpbrVergunning: z
    .string()
    .min(1, "WPBR vergunningnummer is verplicht"),
  wpbrExpiry: z
    .date()
...
export type BedrijfRegistrationFormData = z.infer<typeof bedrijfRegistrationSchema>
export type OpdrachtgeverRegistrationFormData = z.infer<typeof opdrachtgeverRegistrationSchema>
export type ZZPBusinessInfoFormData = z.infer<typeof zzpBusinessInfoSchema>
export type BedrijfBusinessInfoFormData = z.infer<typeof bedrijfBusinessInfoSchema>
