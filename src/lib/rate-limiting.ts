...
export function addRateLimitHeaders(
  ...
  response.headers.set('X-RateLimit-Reset', String(Date.now() + limiter.duration * 1000))
 ...
 */
export async function rateLimitWithTrustCheck(req: NextRequest): Promise<NextResponse | null> {
