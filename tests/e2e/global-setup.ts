  ...
  const testOpdrachten = await Promise.all([
    prisma.opdracht.create({
      data: {
        ...
        omschrijving:
          "Beveiliging tijdens voetbalwedstrijd. Ervaring met crowd control vereist.",
        locatie: "Amsterdam",
        postcode: "1101 AX",
    ...
    prisma.opdracht.create({
      data: {
        ...
        omschrijving:
          "Nachtelijke surveillance in kantoorgebouw centrum Amsterdam.",
...
async function setupAuthenticationState(_config: FullConfig) {
